...
def register():
    """
    Registration is disabled. All accounts are created via team invitations.
    For initial setup, use /api/teams/setup-admin endpoint.
    """
    return jsonify({'error': 'Registration is disabled. Accounts are invite-only. Please contact your super admin.'}), 403
